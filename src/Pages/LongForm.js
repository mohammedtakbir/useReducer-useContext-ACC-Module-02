...
const LongForm = () => {
    ...
    return (
        <div className='h-screen w-screen flex justify-center items-center overflow-auto'>
            <form
                onSubmit={submit}
                className='shadow-xl p-10 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between border'
            ...
            >
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <div className='flex justify-between items-center gap-2 '>
                        ...
                        <div
                            className='border flex-1 flex justify-center items-center h-10 rounded-md border-gray-300'
                        >
